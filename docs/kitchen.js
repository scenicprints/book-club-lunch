...
import { unlockBell, ring } from './bell.js?v=17';
import { CHEESES, EXTRAS, STOCK, burgerSummary, extrasList, esc, placedAt } from './menu.js?v=17';
import { REMINDERS } from './cook.js?v=17';
