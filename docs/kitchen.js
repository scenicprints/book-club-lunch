...
import { unlockBell, ring } from './bell.js?v=15';
import { CHEESES, EXTRAS, STOCK, burgerSummary, extrasList, esc, placedAt } from './menu.js?v=15';
import { REMINDERS } from './cook.js?v=15';
